document.addEventListener("DOMContentLoaded", () => {
  const modelDB = {
    "4t-plus-gsl": {
      ...
      facts: ["Capacidad: 3 pasajeros", "Carga util: 350 kg", "Frenos: Tambor delantero y trasero", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 5,000 km"],
      specs: ["Motor: 198.88 cc", "Potencia: 10.19 HP", "Torque: 17.10 Nm", "Velocidad max.: 65 km/h", "Combustible: Gasolina"],
    },
    "4t-plus-glp": {
      name: "4T Plus GLP",
      image: "../assets/media/images/4T PLUS GLP.png",
      description: "Version enfocada en ahorro operativo con GLP para trayectos frecuentes de pasajeros.",
      facts: ["Capacidad: 3 pasajeros", "Carga util: 340 kg", "Frenos: Tambor delantero y trasero", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 5,000 km"],
    ...
    "4t-plus-gnv": {
      ...
      description: "Configuracion de bajo costo por kilómetro, ideal para operación diaria de alto kilometraje.",
      facts: ["Capacidad: 3 pasajeros", "Carga util: 330 kg", "Frenos: Tambor delantero y trasero", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 5,000 km"],
    ...
    "2t-ug-gsl": {
      ...
      facts: ["Capacidad: 3 pasajeros", "Carga util: 320 kg", "Frenos: Tambor delantero y trasero", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 4,000 km"],
    ...
    "2t-ug-glp": {
      ...
      description: "Version 2T con sistema GLP para reducir costos en operación continua.",
      facts: ["Capacidad: 3 pasajeros", "Carga util: 320 kg", "Frenos: Tambor delantero y trasero", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 4,000 km"],
      specs: ["Motor: 145.45 cc", "Potencia: 8.58 HP", "Torque: 15.00 Nm", "Velocidad max.: 60 km/h", "Combustible: GLP"],
    },
    "maxima-glp": {
      name: "Maxima GLP",
      ...
      facts: ["Capacidad: 2 pasajeros", "Carga util: 500 kg", "Frenos: Tambor reforzado", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 5,000 km"],
      specs: ["Motor: 236.2 cc", "Potencia: 11.06 HP", "Torque: 17.55 Nm", "Velocidad max.: 62 km/h", "Combustible: GLP"],
    },
    "maxima-z-lpg": {
      name: "Maxima Z LPG",
      ...
      facts: ["Capacidad: 2 pasajeros", "Carga util: 550 kg", "Frenos: Tambor reforzado", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 5,000 km"],
    ...
    "titanio-250": {
      ...
      facts: ["Capacidad: 2 pasajeros", "Carga util: 600 kg", "Frenos: Tambor reforzado", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 5,000 km"],
      specs: ["Motor: 236.2 cc", "Potencia: 9.86 HP", "Torque: 18.00 Nm", "Velocidad max.: 62 km/h", "Combustible: Gasolina"],
    },
    "crom-ug-gsl": {
      name: "CROM UG GSL",
      ...
      facts: ["Capacidad: 3 pasajeros", "Carga util: 340 kg", "Frenos: Tambor delantero y trasero", "Garantia: 12 meses o 20,000 km", "Mantenimiento: Cada 5,000 km"],
      specs: ["Cilindraje: 200 cc (referencial)", "Torque: 17.00 Nm", "Uso: Pasajeros urbanos", "Combustible: Gasolina", "Traccion: Posterior"],
    },
  };
